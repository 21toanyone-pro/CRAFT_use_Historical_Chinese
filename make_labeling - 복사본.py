...
def saveLabel():
    ...
    for i in range(0, count): 
        ...
        crop_re_img=Image.fromarray(crop_re_img)
        crop_re_img.save('./resize_img/' + y[i])
        ...
        crop_re_img = cv2.imread('./resize_img/'+y[i], cv2.IMREAD_COLOR)
